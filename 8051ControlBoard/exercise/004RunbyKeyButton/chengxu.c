...
sbit zheng_zhuan=P2^0;  //定义正转按键为P2.0口
sbit fan_zhuan=P2^1; //定义反转按键为P2.1口
/********************************************************************
                        定时中断服务函数
*********************************************************************/
...
main()
{
	...
	if(zheng_zhuan==1){while(!zheng_zhuan)fang_xiang=1;}
    if(fan_zhuan==1){while(!fan_zhuan)fang_xiang=0;}
